...
import { TBill } from './types/types';

const Bill: FC<TBill> = ({ setBill, bill }): ReactElement => {
  ...
  return (
    <div className={styles.bill_container}>
      ...
      <div className={styles.bill_input}>
        ...
        <input type="number" placeholder="0" onChange={handleClick} />
      </div>
    </div>
  );
};
